...
const inputRange = document.querySelector<HTMLInputElement>("#inputRange");
const slider = document.querySelector<SVGCircleElement>("#slider");
const sliderShadow = document.querySelector<SVGCircleElement>("#slider-shadow");
...
const volumeButtonKnob = document.querySelector<HTMLDivElement>(".volume-button-knob");
